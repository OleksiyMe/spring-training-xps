INSERT INTO locationDTO (name, address, postal_code, country, state, city, is_deleted)
...
VALUES ('Hall 1 - EMPIRE', 'McDonald', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Empire 25'), false),
       ('Hall 2 - EMPIRE', 'Kodak', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Empire 25'), false),
       ('Hall 3 - EMPIRE', 'Act Vision', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Empire 25'), false),
       ('Hall 4 - EMPIRE', 'Quick Silver', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Empire 25'), false),

       ('Hall 1 - STREET 14', 'Du Pont', (SELECT l.id from locationDTO l WHERE l.name = 'AMC 34th Street 14'), false),
       ('Hall 2 - STREET 14', 'HBO', (SELECT l.id from locationDTO l WHERE l.name = 'AMC 34th Street 14'), false),
       ('Hall 3 - STREET 14', 'MySpace', (SELECT l.id from locationDTO l WHERE l.name = 'AMC 34th Street 14'), false),
       ('Hall 4 - STREET 14', 'PlayStation', (SELECT l.id from locationDTO l WHERE l.name = 'AMC 34th Street 14'), false),

       ('Hall 1 - SQUARE 13', 'Walt Disney', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Lincoln Square 13'), false),
       ('Hall 2 - SQUARE 13', 'Sony Corporation', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Lincoln Square 13'), false),
       ('Hall 3 - SQUARE 13', 'Warner Bros', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Lincoln Square 13'), false),
       ('Hall 4 - SQUARE 13', 'PlayStation', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Lincoln Square 13'), false),

       ('Hall 1 - VILLAGE 7', 'Du Pont', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Village 7'), false),
       ('Hall 2 - VILLAGE 7', 'Kodak', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Village 7'), false),
       ('Hall 3 - VILLAGE 7', 'MySpace', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Village 7'), false),
       ('Hall 4 - VILLAGE 7', 'Channel 4', (SELECT l.id from locationDTO l WHERE l.name = 'AMC Village 7'), false);
